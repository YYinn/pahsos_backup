...
parser.add_argument('--note', type=str, default='test', help='add on log dir')
...
for fold, (train_idx, val_idx) in enumerate(sfk.split(ori_patient_list, ori_label_list)):
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        val_loss, val_acc, val_f1, val_pre, val_rec, val_auc, val_pred_bi, val_label, val_pred \
                                    = val(model, valid_data, args, criterion, fold, epoch)
